 ...
 *
 * @ConfigEntityType(
 *   id = "product_variation_type_settings",
 *   label = @Translation("Commerce Product Type Settings"),
 *   handlers = {},
 *   config_prefix = "product_variation_type_settings",
 ...
 * )
 */
class CommerceProductVariationTypeSettings extends ConfigEntityBase {
  ...
  public static function load($id) {
    $entity =  \Drupal::entityTypeManager()
      ->getStorage('product_variation_type_settings')
      ->load($id);
    if (!$entity) {
      $entity = \Drupal::entityTypeManager()->getStorage('product_variation_type_settings')
